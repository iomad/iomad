...
$string['cfg_iomadoidcresource_desc'] = 'La risorsa IOMAD OpenID Connect per la quale inviare la richiesta.';
...
$string['cfg_redirecturi_desc'] = 'Si tratta dell\'URI da registrare come "URI di reindirizzamento". L\'Identity Provider di IOMAD OpenID Connect deve richiedere questa informazione durante la registrazione come client. <br /><b>NOTA:</b> devi immettere questa informazione nell\'apposito campo *esattamente* come appare qui. Qualsiasi differenza non consentirà di accedere con IOMAD OpenID Connect.';
...
$string['errorauthnocreds'] = 'Configurare le credenziali cliente IOMAD OpenID Connect.';
$string['errorauthnoendpoints'] = 'Configurare gli endpoint server IOMAD OpenID Connect.';
$string['errorauthnohttpclient'] = 'Impostare un client HTTP.';
$string['errorauthnoidtoken'] = 'IOMAD OpenID Connect id_token non ricevuto.';
$string['errorauthunknownstate'] = 'Stato sconosciuto.';
$string['errorauthuseralreadyconnected'] = 'Sei già connesso a un utente IOMAD OpenID Connect diverso.';
$string['errorauthuserconnectedtodifferent'] = 'L\'utente IOMAD OpenID Connect autenticato è già connesso a un utente Moodle.';
...
$string['erroriomadoidcnotenabled'] = 'Il plugin di autenticazione IOMAD OpenID Connect non è abilitato.';
...
$string['erroriomadoidccall'] = 'Si è verificato un errore in IOMAD OpenID Connect. Consultare i log per ulteriori informazioni.';
$string['erroriomadoidccall_message'] = 'Si è verificato un errore in IOMAD OpenID Connect: {$a}';
$string['eventuserauthed'] = 'Utente autorizzato con IOMAD OpenID Connect';
$string['eventusercreated'] = 'Utente creato con IOMAD OpenID Connect';
$string['eventuserconnected'] = 'Utente connesso a IOMAD OpenID Connect';
$string['eventuserloggedin'] = 'Utente autenticato con IOMAD OpenID Connect';
$string['eventuserdisconnected'] = 'Utente disconnesso da IOMAD OpenID Connect';
$string['iomadoidc:manageconnection'] = 'Gestisci connessione IOMAD OpenID Connect';
