...
The Company availability retriction plugin allows access conditions to be set according the the company a user is assigned to.
...
The plugin can be also installed by adding the contents of this directory to
    ...
    {your/moodle/dirroot}/availability/condition/company
