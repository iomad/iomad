...
The IOMAD merge user accounts plugin is a clone of the tool_merge plugin maintained by Jordi Pujol-Ahulló and Nicolas Dunand. This
version is tenant-aware and only allows users within the same tenant to be merged.
