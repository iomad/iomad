...
The IOMAD course completion availability plugin restricts access to course content, based on courses a user has previously completed.
...
The plugin can be also installed by adding the contents of this directory to
    ...
    {your/moodle/dirroot}/availability/condition/iomadcoursecompletion
