@theme_iomad
Feature: Course sections selector is not available on iomad theme
  ...
  Scenario Outline: Course sections selector is not available on iomad theme regardless of the course format
