@core @core_admin @theme_iomad
Feature: Select a theme in IOMAD theme
  ...
  Scenario: I am able to preview a theme using a modal window
    When I click on "Preview theme 'IOMAD'" "button"
    Then I should see "IOMAD" in the "IOMAD" "dialogue"
    And I should see "IOMAD is a modern highly-customisable theme." in the "IOMAD" "dialogue"
    And I should see "Current theme" in the "IOMAD" "dialogue"

  @javascript
  Scenario: I am able to change the theme using the modal window select button
    Given I should see "Current theme" in the "#theme-card-iomad" "css_element"
  ...
  Scenario: I am able to view a theme's settings page
    Given I click on "Edit theme settings 'IOMAD'" "link"
    Then I should see "IOMAD"
