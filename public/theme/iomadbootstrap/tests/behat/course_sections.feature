@theme_iomadbootstrap
Feature: Select course sections using iomadbootstrap theme
  In order to view course sections when using the iomadbootstrap theme
  As a teacher
  ...
  @javascript
  Scenario: Use the course section selector in iomadbootstrap theme
