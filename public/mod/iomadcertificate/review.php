...
$PAGE->set_url('/mod/iomadcertificate/review.php', ['id' => $cm->id]);
...
$reviewurl = new moodle_url('/mod/iomadcertificate/review.php', ['id' => $cm->id]);
...
echo html_writer::tag(
    'p',
    get_string('viewed', 'iomadcertificate') .
        '<br /> ' .
        userdate($certrecord->timecreated),
