...
The local IOMAD email reports plugin facilitates the automated sending of warning emails e.g.
- courses have not been started
- courses have not been completed
- training is due to expire, etc.
...
The plugin can be also installed by adding the contents of this directory to
    ...
    {your/moodle/dirroot}/local/email_reports
