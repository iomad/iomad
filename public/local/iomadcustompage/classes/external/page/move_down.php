...
/**
 * External API for moving a page down in sort order
 *
 * @package    local_iomadcustompage
 * @copyright  2024 BitAscii Solutions <bitascii.dev@gmail.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class move_down extends external_api {
    /**
    ...
    public static function execute_parameters(): external_function_parameters {
        return new external_function_parameters([
            'pageid' => new external_value(PARAM_INT, 'Page ID to move down'),
        ]);
    }

    /**
     * Move a page down in the sort order
     *
     * @param int $pageid Page ID to move down
     * @return array
    ...
    public static function execute(int $pageid): array {
        ...
        $success = $pagehelper->reorder_page($pageid, constants::PAGE_DOWN);
        ...
        if ($success) {
            ...
            return [
                'success' => false,
                'message' => get_string('cannotmovedown', 'local_iomadcustompage'),
            ];
        }
    }
