...
/**
 * External service definitions for local_iomadcustompage.
 *
...
$functions = [
  'local_iomadcustompage_audiences_delete' => [
    ...
    'type'         => 'write',
    'ajax'         => true,
    'capabilities' => 'local/iomadcustompage:edit',
  ],
  ...
  'local_iomadcustompage_page_update_sort_order' => [
    'classname'    => 'local_iomadcustompage\external\page\update_sort_order',
    'description'  => 'Update the sort order of custom pages',
    'type'         => 'write',
    'ajax'         => true,
    'capabilities' => 'local/iomadcustompage:edit',
  ],
  'local_iomadcustompage_page_move_up' => [
    'classname'    => 'local_iomadcustompage\external\page\move_up',
    'description'  => 'Move a custom page up in sort order',
    'type'         => 'write',
    'ajax'         => true,
    'capabilities' => 'local/iomadcustompage:edit',
  ],
  'local_iomadcustompage_page_move_down' => [
    'classname'    => 'local_iomadcustompage\external\page\move_down',
