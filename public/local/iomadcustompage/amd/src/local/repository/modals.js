 ...
 *
 * @module      local_iomadcustompage/local/repository/modals
 ...
 * @return {ModalForm}
 */
export const createPageModal = (triggerElement, modalTitle, pageId = 0) => {
    return createModalForm(triggerElement, modalTitle, 'local_iomadcustompage\\form\\page', {
        id: pageId,
    });
};
