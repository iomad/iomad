...
use local_iomad\event\user_course_reset;
use moodle_url;

/**
 * Implementation of web service local_iomad_reset_user_course
 *
 * @package    local_iomad
 ...
 */
class reset_user_course extends external_api {

    /**
     * Describes the parameters for local_iomad_reset_user_course
     *
    ...
    public static function execute(int $companyid, int $userid, int $courseid, int $trackid) {
        ...
        // Do the work.
        company_user::delete_user_course($userid, $courseid, 'clear', $trackid);

        // Create an event for this.
        $event = user_course_reset::create(
            [
        ...
        notification::success(get_string('reset_successful', 'local_iomad'));

        return [
            'result' => true,
            'returnmessage' => get_string('reset_successful', 'local_iomad'),
        ];
    }

    /**
     * Describe the return structure for local_iomad_reset_user_course
     *
