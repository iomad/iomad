...
use local_iomad\event\user_course_certificate_recreated;
use moodle_url;

/**
 * Implementation of web service local_iomad_regencert_user_course
 *
 * @package    local_iomad
 ...
 */
class regencert_user_course extends external_api {

    /**
     * Describes the parameters for local_iomad_regencert_user_course
     *
     ...
     * @param mixed $trackid
     */
    public static function execute(int $companyid, int $userid, int $courseid, int $trackid) {
        global $CFG, $DB, $USER;
        ...
        if (track::record_certificates(
            ...
            false,
            false)) {
            $returnmessage = get_string('redocert_successful', 'local_iomad');
            $returnvalue = true;
        } else {
            $returnmessage = get_string('redocert_failed', 'local_iomad');
            $returnvalue = false;
        }

        // Create an event for this.
        $event = user_course_certificate_recreated::create(
            [
    ...
    /**
     * Describe the return structure for local_iomad_regencert_user_course
     *
