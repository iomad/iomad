...
/**
 * Implementation of web service local_iomad_purge_user_course
 *
 * @package    local_iomad
 ...
 */
class purge_user_course extends external_api {

    /**
     * Describes the parameters for local_iomad_purge_user_course
     *
    ...
    public static function execute(int $companyid, int $userid, int $courseid, int $trackid) {
        ...
        // Do the work.
        track::delete_entry($trackid, true);
        ...
        $returnmessage = get_string('purge_successful', 'local_iomad');
    ...
    /**
     * Describe the return structure for local_iomad_purge_user_course
     *
