...
The local IOMAD framework selector provides the classes to build search and select form elements (like the core Moodle user and course
selectors) for competency frameworks.
...
The plugin can be also installed by adding the contents of this directory to
    ...
    {your/moodle/dirroot}/local/framework_selector
