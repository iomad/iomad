...
The local IOMAD learning paths plugin provides the underlying class functions for managing the IOMAD learning paths feature.
...
The plugin can be also installed by adding the contents of this directory to
    ...
    {your/moodle/dirroot}/local/iomad_learningpath
