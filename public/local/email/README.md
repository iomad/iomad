...
The local IOMAD email plugin provides the functionality that allows IOMAD email templates to be configured per tenant.

art of the IOMAD suite of plugins, enhancing the core Moodle feature set with multi-tenant functionalities.
...
The plugin can be also installed by adding the contents of this directory to
    ...
    {your/moodle/dirroot}/local/email
