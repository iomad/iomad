        ...
        foreach ($metadataentities as $metadataurl => $idpentities) {
            foreach ($idpentities as $idpentityid => $idpentity) {
                ...
                $mform->addElement('html', \html_writer::div(
                    get_string('source', 'auth_iomadsaml2', $idpentity['entityid']),
                ...
                $mform->addElement(
                    ...
                    get_string('multiidp:label:displayname', 'auth_iomadsaml2'),
                ...
                $mform->addElement(
                    'advcheckbox',
                    $fieldkey . '[activeidp]',
                    get_string('status', 'auth_iomadsaml2'),
                    get_string('multiidp:label:active', 'auth_iomadsaml2'),
                    [],
                    [false, true]
                );
                ...
                $mform->addElement(
                    'advcheckbox',
                    $fieldkey . '[defaultidp]',
                    get_string('multiidp:label:defaultidp', 'auth_iomadsaml2'),
                    '',
                    [],
                    [false, true]
                );
                ...
                $mform->addElement(
                    'advcheckbox',
                    $fieldkey . '[adminidp]',
                    get_string('multiidp:label:admin', 'auth_iomadsaml2'),
                    '',
                    [],
                    [false, true]
                );
