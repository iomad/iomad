...
/**
 * Unit tests for the class \auth_iomadoidc\observers
 *
 ...
 * @group     office365
 * @coversDefaultClass \auth_iomadoidc\observers
 */
final class observers_test extends advanced_testcase {
    ...
    /**
     * IOMADOIDC user token is deleted when the Moodle user is deleted.
     *
     * @return void
    ...
    public function test_token_is_deleted_when_user_is_deleted(): void {
        ...
        // Insert an entry in auth_iomadoidc_token.
        $DB->insert_record(
            ...
            [
                ...
                'username' => 'username',
                'iomadoidcusername' => 'iomadoidcusername',
                'scope' => 'scope',
        ...
        $this->assertTrue($DB->record_exists('auth_iomadoidc_token', ['userid' => $user->id]));
        ...
        $this->assertFalse($DB->record_exists('auth_iomadoidc_token', ['userid' => $user->id]));
    }
