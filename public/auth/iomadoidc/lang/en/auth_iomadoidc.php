...
<li><b>Force redirect</b> (auth_iomadoidc/forceredirect) setting above is enabled.</li>
</ul>
...
$string['task_cleanup_iomadoidc_sid'] = 'Clean up IOMADOIDC SID records';
...
$string['privacy:metadata:auth_iomadoidc_token:useridentifier'] = 'The user identifier of the IOMADOIDC user';
...
$string['privacy:metadata:auth_iomadoidc_sid'] = 'IdP session identifiers (sid) used to find connected Moodle users when SLO is triggered from IdP';
$string['privacy:metadata:auth_iomadoidc_sid:userid'] = 'The ID of the Moodle user';
$string['privacy:metadata:auth_iomadoidc_sid:sid'] = 'The IdP session identifier (sid)';
$string['privacy:metadata:auth_iomadoidc_sid:timecreated'] = 'The time when the mapping was created';
...
$string['table_iomadoidc_unique_identifier'] = 'IOMADOIDC unique identifier';
...
<li>Backup Moodle database, in particular <span class="code">user</span> and <span class="code">auth_iomadoidc_tokens</span> tables. If local_o365 plugin is installed, backup <span class="code">local_o365_objects</span> table too.</li>
<li>Use the <a href="{$a}" target="_blank">update binding username tool</a> to update Moodle username, auth_iomadoidc token, and other connection records of the existing user to match the value of the claim to be changed to.</li>
...
$string['cleanup_iomadoidc_tokens_link_desc'] = 'To clean up obsolete OpenID Connect tokens, use the <a href="{$a}">Cleanup OpenID Connect tokens</a> tool.';
...
$string['update_error_user_not_iomadoidc'] = 'The user is not using OpenID Connect authentication method. Will try update manually matched user.';
...
<ul>
<li>If a user is found in the step 1 above, then find the token record in the <span class="code">auth_iomadoidc_token</span> table for the user, and update <span class="code">username</span> column to be the lowercase of <span class="code">new_username</span>, and <span class="code">iomadoidcusername</span> column to be the same as <span class="code">new_username</span>.</li>
<li>If no record is found above, it will try to find record in the <span class="code">auth_iomadoidc_token</span> with <span class="code">iomadoidcusername</span> column matching the old <span class="code">username</span>, and update it to be <span class="code">newusername</span>.</li>
</ul>
