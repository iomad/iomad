...
$string['configairnotifieraccesskey'] = 'Get an access key by clicking \'Request access key\' below (registered sites only) or by creating an account on the <a href="https://apps.moodle.com">Moodle Apps Portal</a>.';
...
$string['notconfigured'] = 'Configure the AirNotifier server to enable push notifications.';
...
$string['sitemustberegistered'] = 'Register your site to use the public AirNotifier instance, or get an access key by creating an account on the <a href="https://apps.moodle.com">Moodle Apps Portal</a>.';
