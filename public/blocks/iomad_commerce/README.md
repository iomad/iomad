...
The IOMAD commerce block enables the sale of courses to tenant users using either the license or manual enrolment methods. Products are
priced per tenant, and the block allows for an ecommerce experience in IOMAD using the core Moodle payment gateway plugins as the back end.
