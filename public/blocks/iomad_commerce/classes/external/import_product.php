...
/**
 * Implementation of web service block_iomad_commerce_import_product
 *
 * @package    block_iomad_commerce
 * @copyright  2026 E-Learn Design https://www.e-learndesign.co.uk
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class import_product extends external_api {

    /**
     * Describes the parameters for block_iomad_commerce_import_product
     *
    ...
    public static function execute($mycompanyid, $companyid, $productid) {
        ...
        // Do the work.
        if (helper::import_item_to_company($product->id, $mycompanyid)) {
            $returnstring = get_string('productimportedsuccessfully', 'block_iomad_commerce');
            $result = true;
        } else {
            $returnstring = get_string('productimportfailed', 'block_iomad_commerce');
            $result = false;
        }
    ...
    /**
     * Describe the return structure for block_iomad_commerce_import_product
     *
