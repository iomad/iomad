...
/**
 * Search area for block_iomad_html blocks
 *
...
namespace block_iomad_html\search;
...
class content extends \core_search\base_block {
    ...
    /**
     * Set the block content as a searchable document
     *
     * @param object $record
     * @param array $options
     * @return void
    ...
    public function attach_files($document) {
        ...
        $files = $fs->get_area_files($context->id, 'block_iomad_html', 'content',
