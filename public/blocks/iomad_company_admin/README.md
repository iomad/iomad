...
The IOMAD company admin block provides the main IOMAD dashboard for all tenant management activities and actions.
...
The plugin can be also installed by adding the contents of this directory to
    ...
    {your/moodle/dirroot}/blocks/iomad_company_admin
