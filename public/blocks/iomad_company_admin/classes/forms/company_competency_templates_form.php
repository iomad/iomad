...
/**
 * IOMAD Dashboard company competency templates form class
 *
...
use local_iomad\template_selector\{current_company, potential_company};
use moodleform;
...
class company_competency_templates_form extends moodleform {
    ...
    /** @var object potential company templates */
    protected $potentialtemplates = null;

    /** @var object current company templates */
