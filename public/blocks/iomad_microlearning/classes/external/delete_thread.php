...
/**
 * Implementation of web service block_iomad_microlearning_delete_thread
 *
 ...
 */
class delete_thread extends external_api {

    /**
     * Describes the parameters for block_iomad_microlearning_delete_thread
     *
    ...
    public static function execute($threadid, $companyid) {
        ...
        // Do the work.
        microlearning::delete_thread($threadid);

        return true;
    }

    /**
     * Describe the return structure for block_iomad_microlearning_delete_thread
     *
