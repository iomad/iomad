...
/**
 * Implementation of web service block_iomad_microlearning_move_nugget
 *
 * @package    block_iomad_microlearning
 * @copyright  2026 E-Learn Design https://www.e-learndesign.co.uk
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class move_nugget extends external_api {

    /**
     * Describes the parameters for block_iomad_microlearning_move_nugget
     *
    ...
    public static function execute_parameters(): external_function_parameters {
        return new external_function_parameters([
            ...
            'direction' => new external_value(PARAM_INT, 'Direction'),
     ...
     * Implementation of web service block_iomad_microlearning_move_nugget
     *
     * @param mixed $nuggetid
     * @param mixed $threadid
     * @param mixed $direction
     * @param mixed $companyid
     */
    public static function execute($nuggetid, $threadid, $direction, $companyid) {
    ...
    /**
     * Describe the return structure for block_iomad_microlearning_move_nugget
     *
