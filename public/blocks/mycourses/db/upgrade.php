...
/**
 * This file keeps track of upgrades to the mycourses block
 *
...
/**
 * Upgrade code for the My Courses block.
 *
...
function xmldb_block_mycourses_upgrade($oldversion) {
    ...
    if ($oldversion < 2024082700) {
        upgrade_block_delete_instances('mycourses', '__default', 'my-index');
        ...
        upgrade_block_set_my_user_parent_context('mycourses', '__default', 'my-index');

        upgrade_block_savepoint(true, 2024082700, 'mycourses', false);
    }
