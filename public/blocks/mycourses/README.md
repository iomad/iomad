...
The IOMAD My courses block is a reworking of the core Moodle course overview block which also displays courses which the user has valid license access to as well as the option
to download all of their own saved certificates.
...
The plugin can be also installed by adding the contents of this directory to
    ...
    {your/moodle/dirroot}/blocks/mycourses
