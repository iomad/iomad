...
final class generator_test extends \advanced_testcase {
    public function test_generator(): void {
        ...
        /** @var block_iomad_onlineusers_generator $generator */
        $generator = $this->getDataGenerator()->get_plugin_generator('block_iomad_onlineusers');
        $this->assertInstanceOf('block_iomad_onlineusers_generator', $generator);
        $this->assertEquals('iomad_onlineusers', $generator->get_blockname());
