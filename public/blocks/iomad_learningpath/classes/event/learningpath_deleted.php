 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class learningpath_deleted extends base {
    ...
    protected function init() {
        ...
        $this->data['objecttable'] = 'block_iomad_learningpath';
    }
    ...
    public static function get_name() {
        return get_string('learningpathdeleted', 'block_iomad_learningpath');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' deleted a new learning path with id " .
               "'$this->objectid'";
    }
