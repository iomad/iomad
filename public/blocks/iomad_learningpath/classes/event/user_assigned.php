 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class user_assigned extends base {
    ...
    public static function get_name() {
        return get_string('userassigned', 'block_iomad_learningpath');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' assigned the user with id " .
               "'$this->relateduserid' to the learning path with id '$this->objectid'";
    }
