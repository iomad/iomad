 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class user_unassigned extends base {
    ...
    protected function init() {
        ...
        $this->data['objecttable'] = 'block_iomad_learningpath_users';
    }
    ...
    public static function get_name() {
        return get_string('userunassigned', 'block_iomad_learningpath');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' removed the user with id " .
               "'$this->relateduserid' from the learning path with id '$this->objectid'";
    }
