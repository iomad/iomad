    ...
    return {
        ...
        init: function(companyid, pathid) {
            ...
            function user_list() {
                ...
                ajax.call([{
                    methodname: 'block_iomad_learningpath_getprospectiveusers',
            ...
            function pathuser_list() {
                ...
                // call the web service
                ajax.call([{
                    methodname: 'block_iomad_learningpath_getusers',
            ...
            $('#prospectivelist').on('click', 'li', function() {
                ...
                ajax.call([{
                    methodname: 'block_iomad_learningpath_addusers',
            ...
            $('#pathuserlist').on('click', 'li', function() {
                ...
                ajax.call([{
                    methodname: 'block_iomad_learningpath_removeusers',
                    args: {pathid: pathid, userids: [userid]},
                    done: function() {
