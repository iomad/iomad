...
The Redo Certifications admin tool plugin allows users to re-generate the stored certificates for users which are held as part of the IOMAD reporting data.
...
The plugin can be also installed by adding the contents of this directory to
    ...
    {your/moodle/dirroot}/admin/tool/redocerts
