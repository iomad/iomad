...
$string['pathssubwwwroot'] = '<p>הכתובת המלאה שאליה ייגש Moodle, כלומר הכתובת שמשתמשים יזינו בשורת הכתובת של הדפדפן שלהם כדי לגשת ל-Moodle.</p>
<p>לא ניתן לגשת ל-Moodle באמצעות מספר כתובות. אם האתר שלך נגיש דרך מספר כתובות, בחר את הקלה ביותר והגדר הפניה קבועה לכל אחת מהכתובות האחרות.</p>
<p>אם האתר שלך נגיש הן מהאינטרנט והן מרשת פנימית (הנקראת לעיתים אינטראנט), השתמש בכתובת הציבורית כאן.</p>
<p>אם הכתובת הנוכחית אינה נכונה, אנא שנה את כתובת ה-URL בשורת הכתובת של הדפדפן שלך והפעל מחדש את ההתקנה.</p>';
