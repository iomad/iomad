...
class mod_iomadcertificate_mod_form extends moodleform_mod {
    ...
    public function definition() {
        ...
        $mform->addElement('text', 'name', get_string('iomadcertificatename', 'iomadcertificate'), ['size' => '64']);
        ...
        $mform->addElement(
            'text',
            'emailothers',
            get_string('emailothers', 'iomadcertificate'),
            ['size' => '40', 'maxsize' => '200']
        );
        ...
        $deliveryoptions = [
            0 => get_string('openbrowser', 'iomadcertificate'),
            1 => get_string('download', 'iomadcertificate'),
            2 => get_string('emailiomadcertificate', 'iomadcertificate'),
        ];
        ...
        $mform->addElement('text', 'requiredtime', get_string('coursetimereq', 'iomadcertificate'), ['size' => '3']);
        ...
        $dateformatoptions = [
            ...
            3 => '1 January 2000',
            4 => 'January 2000',
            5 => get_string('userdateformat', 'iomadcertificate'),
        ];
        ...
        $gradeoptions = iomadcertificate_get_grade_options() +
                        iomadcertificate_get_grade_categories($this->current->course) +
                        $modules;
        ...
        $gradeformatoptions = [
            1 => get_string('gradepercent', 'iomadcertificate'),
            2 => get_string('gradepoints', 'iomadcertificate'),
        ...
        $mform->addElement(
            'text',
            'printhours',
            get_string('printhours', 'iomadcertificate'),
        ...
        $mform->addElement(
            'textarea',
            'customtext',
            get_string('customtext', 'iomadcertificate'),
        ...
        $mform->addElement(
            ...
            get_string('iomadcertificatetype', 'iomadcertificate'),
            iomadcertificate_types()
        );
        ...
        $orientation = [
            'L' => get_string('landscape', 'iomadcertificate'),
            'P' => get_string('portrait', 'iomadcertificate'),
        ];
        ...
        $mform->addElement(
            'select',
            'borderstyle',
            get_string('borderstyle', 'iomadcertificate'),
            iomadcertificate_get_images(CERT_IMAGE_BORDER)
        );
        ...
        $printframe = [
            0 => get_string('no'),
            1 => get_string('borderblack', 'iomadcertificate'),
            2 => get_string('borderbrown', 'iomadcertificate'),
            3 => get_string('borderblue', 'iomadcertificate'),
            4 => get_string('bordergreen', 'iomadcertificate'),
        ];
        ...
        $mform->addElement(
            'select',
            'printwmark',
            get_string('printwmark', 'iomadcertificate'),
            iomadcertificate_get_images(CERT_IMAGE_WATERMARK)
        );
        ...
        $mform->addElement(
            'select',
            'printsignature',
            get_string('printsignature', 'iomadcertificate'),
            iomadcertificate_get_images(CERT_IMAGE_SIGNATURE)
        );
        ...
        $mform->addElement(
            'select',
            'printseal',
            get_string('printseal', 'iomadcertificate'),
            iomadcertificate_get_images(CERT_IMAGE_SEAL));
