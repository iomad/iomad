...
class backup_iomadcertificate_activity_structure_step extends backup_activity_structure_step {
    ...
    protected function define_structure() {
        ...
        $iomadcertificate = new backup_nested_element('iomadcertificate', ['id'], [
        ...
        // Define sources.
        $iomadcertificate->set_source_table('iomadcertificate', ['id' => backup::VAR_ACTIVITYID]);

        // All the rest of elements only happen if we are including user info.
        if ($userinfo) {
            $issue->set_source_table('iomadcertificate_issues', ['iomadcertificateid' => backup::VAR_PARENTID]);
        }
