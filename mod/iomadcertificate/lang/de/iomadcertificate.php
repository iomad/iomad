...
$string['verifyiomadcertificate'] = 'Zertifikat verifizieren	';
$string['viewiomadcertificateviews'] = 'View {$a} issued certificates';
$string['viewed'] = 'Sie erhielten dieses Zertifikat am:';
$string['viewtranscript'] = 'Zeige Zertifikate';
$string['watermark'] = 'Wasserzeichen';
$string['companycertify'] = 'Diese Teilnahmebescheinigung bestätigt,dass ';
$string['companydetailsone'] = 'erfolgreich den Kurs';
$string['companydetailstwo'] = 'abgeschlossen hat';
$string['companyscore'] = 'Mit einer Gesamtbewertung von {$a}';
$string['companydate'] = 'am {$a}';
$string['companydatecap'] = 'Am {$a}';
