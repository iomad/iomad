...
$pdf->SetTitle(format_string($iomadcertificate->name, true)); //THOMAS
...
iomadcertificate_print_text($pdf, $x, $y + 68, $alignment, 'freeserif', '', 20, format_string($course->fullname, true)); //THOMAS
