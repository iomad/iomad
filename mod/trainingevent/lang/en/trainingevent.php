...
$string['coursecapacity'] = 'Capacity';
$string['coursecapacity_help'] = "Set how many participants can fit in the room for this training. Only required if the room doesn't always fit the same number of people";
$string['coursecapacity_error'] = 'capacity must be one or more people';
