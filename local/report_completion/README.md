...
The local IOMAD report completion plugin provides course completion information across all courses for all users, including any
historic completion records.
