...
The IOMAD local report completion plugin provides course completion information across all courses for all users, including any historic completion records.
...
The plugin can be also installed by adding the contents of this directory to
    ...
    {your/moodle/dirroot}/local/report_completion
