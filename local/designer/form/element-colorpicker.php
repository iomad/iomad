...
/**
 * Designer pro course format - Form element for color picker.
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class moodlequickform_designercolorpicker extends MoodleQuickForm_text implements templatable {
    ...
    public function __construct($elementname=null, $elementlabel=null, $attributes=null) {
        ...
        $this->updateAttributes(['class' => $class.' local-designer-form-colour-picker ']);
    }
