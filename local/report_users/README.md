...
The IOMAD local report users plugin provides course completion information, including historic, for all courses for a selected user.
...
The plugin can be also installed by adding the contents of this directory to
    ...
    {your/moodle/dirroot}/local/report_users
