...
// Add text
    ...
    cert_printtext($x, $custy + 6, 'C', 'freeserif', '', '20', iomad_settings_replacement($certificate->customtext2, $course, $serialnumber, $certdate));
    cert_printtext($x, $custy + 12, 'C', 'freeserif', '', '20', iomad_settings_replacement($certificate->customtext3, $course, $serialnumber, $certdate));
?>
