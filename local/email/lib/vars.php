...
class EmailVars {
    ...
    static function vars() {
        ...
        $result = array(
            ...
            // *** ClassRoom fields ***
                        'Classroom_Name', 'Classroom_Address', 'Classroom_Postcode', 'Classroom_City', 'Classroom_Country', 'Classroom_Capacity', 'Classroom_Summary','Classroom_Time',
            // *** Site fields ***
        ...
        // or to create methods with specific formatting of the values (just don't give those methods names starting with 'User_', 'Course_', etc)
