...
The IOMAD local report companies plugin provides overview information on the tenants defined within the IOMAD site.
...
The plugin can be also installed by adding the contents of this directory to
    ...
    {your/moodle/dirroot}/local/report_companies
