...
The IOMAD local track plugin provides the automation for recording information which is used by the IOMAD reports.
...
The plugin can be also installed by adding the contents of this directory to
    ...
    {your/moodle/dirroot}/local/iomad_track
