...
if (strpos($_SERVER['REQUEST_URI'], 'azure_scim.php') !== false) {
    $scimuserid = '';
    ...
    if (strpos($_SERVER['REQUEST_URI'], '/azure_scim.php/Users') !== false || strpos($_SERVER['REQUEST_URI'], '/azure_scim.php/v2/Users') !== false) {
