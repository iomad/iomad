...
M.core_user.init_user_selector = function (Y, name, hash, extrafields, lastsearch) {
    ...
    var user_selector = {
        ...
        handle_keyup : function(e) {
            profileFieldSelect = document.getElementById(this.name + '_custom_srch');
            vl = profileFieldSelect.value;
        ...
        send_query : function(forceresearch) {
            ...
            var iotrans = Y.io(M.cfg.wwwroot + '/local/iomad/classes/user_selector/search.php', {
                method: 'POST',
