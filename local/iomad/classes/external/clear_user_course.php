...
/**
 * Implementation of web service local_iomad_clear_user_course
 *
 * @package    local_iomad
 ...
 */
class clear_user_course extends external_api {

    /**
     * Describes the parameters for local_iomad_clear_user_course
     *
    ...
    public static function execute(int $companyid, int $userid, int $courseid, int $trackid) {
        ...
        // Do the work.
        company_user::delete_user_course($userid, $courseid, 'delete', $trackid);
        ...
        $returnmessage = get_string('clear_successful', 'local_iomad');
    ...
    /**
     * Describe the return structure for local_iomad_clear_user_course
     *
