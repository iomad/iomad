 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class unenroluserstask extends adhoc_task {
    ...
    public function get_name() {
        return get_string('unenroluserstask', 'local_iomad');
    }

    /**
     * Run unenroluserstask
     */
     ...
     *
     */
    public static function queue_task($userids, $courseid, $companyid) {
        // Let's set up the adhoc task.
        $task = new unenroluserstask();
