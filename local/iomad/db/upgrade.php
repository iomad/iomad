...
function xmldb_local_iomad_upgrade($oldversion) {
    ...
    if ($oldversion < 2017090315) {
        ...
        // Iomad savepoint reached.
        upgrade_plugin_savepoint(true, 2017090315, 'local', 'iomad');
    }

    if ($oldversion < 2017090316) {
        ...
        // Iomad savepoint reached.
        upgrade_plugin_savepoint(true, 2017090316, 'local', 'iomad');
    }
