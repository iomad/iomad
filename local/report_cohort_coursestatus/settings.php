...
$ADMIN->add('IomadReports', new admin_externalpage('repcohortstatus',
    get_string('repcohortstatus', 'local_report_cohort_coursestatus'), $url, 'local/report_cohort_coursestatus:view'));