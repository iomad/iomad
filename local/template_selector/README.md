...
The IOMAD local template selector plugin provides the same functionality as the core Moodle user selector plugin for learning path templates.
...
The plugin can be also installed by adding the contents of this directory to
    ...
    {your/moodle/dirroot}/local/template_selector
