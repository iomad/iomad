...
The local IOMAD report attendance plugin provides reporting information on attendees of the IOMAD face-to-face training event activities.
...
The plugin can be also installed by adding the contents of this directory to
    ...
    {your/moodle/dirroot}/local/report_attendance
