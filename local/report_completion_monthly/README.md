...
The IOMAD local report completion monthly plugin provides report information for totals of course completions grouped by calendar month.
...
The plugin can be also installed by adding the contents of this directory to
    ...
    {your/moodle/dirroot}/local/report_completion_monthly
