...
The local IOMAD report user license allocation plugin provides detailed reports on which users have been allocated which license/course,
when, and how many times (if relevant).
