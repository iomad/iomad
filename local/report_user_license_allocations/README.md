...
The IOMAD local report user license allocation plugin provides detailed reports on which users have been allocated which license/course, when and how many times (if relevant).
...
The plugin can be also installed by adding the contents of this directory to
    ...
    {your/moodle/dirroot}/local/report_user_license_allocations
