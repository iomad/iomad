...
The IOMAD local OIDC sync plugin provides functionality to automatically synchronise users with their own tenant OIDC setup and their tenants in IOMAD.
