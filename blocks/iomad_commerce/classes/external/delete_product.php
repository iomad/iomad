...
use block_iomad_commerce\event\product_deleted;
...
/**
 * Implementation of web service block_iomad_commerce_delete_product
 *
 * @package    block_iomad_commerce
 * @copyright  2026 E-Learn Design https://www.e-learndesign.co.uk
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class delete_product extends external_api {

    /**
     * Describes the parameters for block_iomad_commerce_delete_product
     *
    ...
    public static function execute($mycompanyid, $companyid, $productid) {
        ...
        // Do the work.
        $DB->delete_records('block_iomad_commerce_products', ['id' => $product->id]);
        ...
        $DB->delete_records('block_iomad_commerce_product_blockprices', ['itemid' => $product->id]);

        // Is this a product or a template?
        if ($companyid > 0) {
            $returnstring = get_string('productdeletedok', 'block_iomad_commerce');
        } else {
            $returnstring = get_string('templatedeletedok', 'block_iomad_commerce');
        }
    ...
    /**
     * Describe the return structure for block_iomad_commerce_delete_product
     *
