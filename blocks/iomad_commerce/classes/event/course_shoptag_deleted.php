...
class course_shoptag_deleted extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('courseshoptagdeleted', 'block_iomad_commerce');
    }
    ...
    public function get_description() {
        return "The user with id $this->userid deleted the course_shoptag with the id $this->objectid";
    }
