...
$string['coursedeletecheckfull'] = 'Are you absolutely sure you want to delete the product \'{$a}\' and its settings from the shop?';
$string['courses'] = 'Products';
$string['courseshoptagcreated'] = 'Course shop tag created successfully.';
$string['courseshoptagdeleted'] = 'Course shop tag deleted successfully.';
$string['courseunavailable'] = 'This product is not available.';
$string['createproduct'] = 'Create new product';
...
$string['exportproductcheckfull'] = 'This will save the product item \'{$a}\' as a template which can then be allocated to other companies.';
...
$string['howmanylicenses'] = 'How many licenses?';
$string['importproduct'] = 'Import product item';
$string['importproductcheckfull'] = 'This will create a new product item in the current company shop from the \'{$a}\' template. Any courses which the current company cannot see will be removed from the product, so please check the new product setings after importing.';
...
$string['nocoursesontheshop'] = 'No products or templates found.';
$string['noinvoices'] = 'No invoices found.';
...
$string['privacy:metadata:invoice:id'] = 'ID from the {block_iomad_commerce_invoices} table';
...
$string['productcreated'] = 'Product created event';
$string['productcreatefailed'] = 'There was an issue creating this new product.';
$string['productdeleted'] = 'Product deleted event';
$string['productdeletedok'] = 'Product successfully deleted.';
...
$string['productimportedsuccessfully'] = 'Template item was successfully saved as a new product.';
...
$string['productupdated'] = 'Product updated event';
$string['productupdatedok'] = 'Product successfully updated.';
$string['productupdatefailed'] = 'There was an issue updating this product.';
...
$string['templatecreatedok'] = 'Template created successfully.';
$string['templatecreatefailed'] = 'There was an issue creating this template.';
$string['templatedeletedok'] = 'Template successfully deleted.';
$string['templateupdatedok'] = 'Template updated successfully.';
$string['templateupdatefailed'] = 'There was an issue updating this template.';
$string['total'] = 'Total';
