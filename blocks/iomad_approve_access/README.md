...
The IOMAD approve access block is used by company managers to approve or deny access requests from their users to attend training event activities.
...
The plugin can be also installed by adding the contents of this directory to
    ...
    {your/moodle/dirroot}/blocks/iomad_approve_access
