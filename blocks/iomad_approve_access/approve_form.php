    ...
    function definition() {
        ...
        if ($results = approve_enroll_get_my_users()) {
            ...
            foreach($results as $result) {
                ...
                $radioarray = array();
                $radioarray[] =& $mform->createElement('radio', 'approve_'.$result->userid.'_'.$result->courseid, '', get_string('approve').$managerapproved, 1);
                $radioarray[] =& $mform->createElement('radio', 'approve_'.$result->userid.'_'.$result->courseid, '', get_string('deny', 'block_iomad_approve_access'), 2);
