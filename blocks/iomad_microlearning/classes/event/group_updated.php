...
/**
 * The block_iomad_microlearning group updated event.
 *
...
class group_updated extends base {
    ...
    public static function get_name() {
        return get_string('groupupdated', 'block_iomad_microlearning');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' updated the microlearning group with id '$this->objectid'";
    }
