...
class user_departments_editable extends \core\output\inplace_editable {
    ...
    public function __construct($company, $companycontext, $user, $userdepartments, $departments, $assignabledepartments = null) {
        ...
        //$editable = iomad::has_capability('block/iomad_company_admin:editusers', $companycontext); Thomas: returns FALSE, I don't know...
        $editable = true; //Workaround by Thomas 26.10.2024 - should be fixed later
