...
/**
 * IOMAD Dashboard course warn not started in-place editable class
 *
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class courses_warnnotstarted_editable extends inplace_editable {
    ...
    public static function update($itemid, $newvalue) {
        ...
        // Process changes.
        $DB->set_field('local_iomad_courses', 'warnnotstarted', $warnnotstarted, ['courseid' => $courseid]);
