            ...
            if ($existinguser) {
                ...
                if ($passeddepartment) {
                    ...
                    if ($updatetype == 1 || $updatetype == 2) {
                        $existinguserdeps = $DB->get_records(
                        ...
                        foreach ($existinguserdeps as $existinguserdep) {
                            ...
                            if ($DB->record_exists(
                                ...
                                // Delete records in local_iomad_company_users for this department id with this user.
                                $DB->delete_records(
                                    'local_iomad_company_users',
                                    [
                                        'userid' => $existinguser->id,
                    ...
                    foreach ($newdepartments as $newdepartment) {
                        ...
                        if ($DB->record_exists(
                            ...
                            // Insert new record.
                            $DB->insert_record('local_iomad_company_users', $userdep);
                        } else {
