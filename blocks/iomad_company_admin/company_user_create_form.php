...
class user_edit_form extends company_moodleform {
    ...
    public function definition() {
        ...
        $managerarray = array();
        if (has_capability('block/iomad_company_admin:assign_department_manager', get_context_instance(CONTEXT_SYSTEM))) {
        ...
        if (has_capability('block/iomad_company_admin:assign_company_manager', get_context_instance(CONTEXT_SYSTEM))) {
...
} else if (!has_capability('block/iomad_company_admin:edit_departments', get_context_instance(CONTEXT_SYSTEM))) {
