...
$string['applyroletemplate'] = 'Apply role template';
...
$string['autocourses_help'] = 'This is the list of courses which users created using the local LLL-Signup process will automatically get enrolled on.';
...
$string['companydomains_help'] = 'List of company domains is used for self sign up users. They are automatically added into the appropriate company as long as they meet the right criteria.';
...
$string['designatedcompany'] = 'Designamted company';
...
$string['edit_companies_title'] = 'LLL-company settings';
...
$string['emailprofileid_help'] = 'Select the email profile of the external supervisor.';
...
$string['iomad_company_admin:addinstance'] = 'Add a new LLL-company admin block';
...
$string['iomad_company_admin:manageframeworks'] = 'Manage LLL-competency framework settings';
$string['iomad_company_admin:managetemplates'] = 'Manage LLL-learning plan template settings';
$string['iomad_company_admin:myaddinstance'] = 'Add a new LLL-company admin block to the users dashboard';
$string['iomad_company_admin:restrict_capabilities'] = 'Restrict LLL-role capabilties for company';
...
$string['frameworksettings'] = 'Manage LLL-framework settings';
...
$string['licensetotal'] = ' licenses have been allocated';
...
$string['licenseusedwarning'] = '<span style="text-align: center">* Users who are marked with an asterix are already using their license allocation for a course and so cannot have their license taken away from them.</br></span>';
$string['license_users_for'] = 'Users for license \'{$a}\' ';
$string['licenseusers'] = 'User license allocations';
$string['listroles'] = 'Show LLL-roles';
...
$string['iomad_company_courses_title'] = 'Manage LLL-course settings';
$string['iomad_company_frameworks_title'] = 'Manage LLL-competency framework settings';
$string['iomad_company_templates_title'] = 'Manage LLL-competency template settings';
$string['iomad_courses_title'] = 'Manage LLL-course settings';
$string['iomadreports'] = 'Company reports';
$string['parentcompany'] = 'Parent company';
$string['parentcompany_help'] = 'Choose a company as parent company. Company manager of the partent can manage the child.';
...
$string['pluginname'] = 'LLL-Company / User Admin';
...
$string['roletemplate_help'] = 'Role templates can be created under \'restrict capabilities\'.';
...
$string['showothermanagers_help'] = 'Choose this if you would like to show company managers from other companies.  This is only available if the role type you are assigning is the company manager one.';
...
$string['templatesettings'] = 'Manage LLL-template settings';
$string['theoptionsbelow'] = '<p><b>NOTE: The options below may only work with the LLL-themes</b></p>';
...
$string['companymanagersforminfo'] = 'List of users of selected company/department';
