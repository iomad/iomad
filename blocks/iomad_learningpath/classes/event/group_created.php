...
class group_created extends base {
    ...
    protected function init() {
        ...
        $this->data['objecttable'] = 'iomad_learningpathgroup';
    }
    ...
    public static function get_name() {
        return get_string('sectioncreated', 'block_iomad_learningpath');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' created a new learning path section with id " .
               "'$this->objectid' for the learning path with id '" . $this->other['learningpathid'] . "'";
    }
