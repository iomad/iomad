 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class course_added extends base {
    ...
    protected function init() {
        ...
        $this->data['objecttable'] = 'iomad_learningpathcourse';
    }
    ...
    public static function get_name() {
        return get_string('courseadded', 'block_iomad_learningpath');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' added the course with id '$this->objectid' to the " .
               "learning path section with id '" . $this->other['groupid'] . "' for the learning path " .
               "with id '" . $this->other['learningpathid'] . "'";
    }
    ...
    protected function validate_data() {
        ...
        if (!array_key_exists('learningpathid', $this->other)) {
    ...
    public static function get_other_mapping() {
        ...
        $othermapped['learningpathid'] = ['db' => 'iomad_learningpath'];
        $othermapped['groupid'] = ['db' => 'iomad_learningpathgroup'];
