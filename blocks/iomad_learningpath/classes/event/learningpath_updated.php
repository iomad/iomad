 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class learningpath_updated extends base {
    ...
    public static function get_name() {
        return get_string('learningpathupdated', 'block_iomad_learningpath');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' updated the learning path with id " .
               "'$this->objectid'";
    }
