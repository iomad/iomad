...
$string['deletegroupcheckfull'] = 'Are you sure you want to dete the section \'{$a}\' and remove any courses it contains from the leaning path?';
$string['deletepath'] = 'Delete path';
$string['dependent'] = 'Dependent';
$string['dependent_help'] = 'If the value is Yes, then the the previous section must be fully completed before access to this section is granted.';
...
$string['groupname_help'] = 'Give the section for courses a name';
...
$string['nopathscreated'] = 'No learning paths have been created';
...
$string['sequence_help'] = 'If this value is set to Yes, then courses within this section must be completed in order.';
