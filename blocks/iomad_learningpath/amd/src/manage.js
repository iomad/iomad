    ...
    return {
        ...
        init: function() {
            ...
            $('.lp_active').click(function() {
                ...
                ajax.call([{
                    methodname: 'block_iomad_learningpath_activate',
            ...
            $('.lp_delete').click(function() {
                var id = $(this).data('id');
                str.get_strings([
                    {key: 'confirm', component: 'block_iomad_learningpath'},
                    {key: 'confirmdelete', component: 'block_iomad_learningpath'},
                    {key: 'yes'},
                    {key: 'no'}
                ]).done(function(s) {
                    notification.confirm(s[0], s[1], s[2], s[3], function() {
                        ajax.call([{
                            methodname: 'block_iomad_learningpath_deletepath',
                            args: { pathid: id },
                            done: function() {
                                location.reload();
                            },
            ...
            $('.lp_copy').click(function() {
                ...
                str.get_strings([
                    {key: 'confirm', component: 'block_iomad_learningpath'},
                    {key: 'confirmcopy', component: 'block_iomad_learningpath'},
                    {key: 'yes'},
                    {key: 'no'}
                ]).done(function(s) {
                    notification.confirm(s[0], s[1], s[2], s[3], function() {
                        ajax.call([{
                            methodname: 'block_iomad_learningpath_copypath',
                            args: { pathid: id },
                            done: function() {
                                location.reload();
                            },
