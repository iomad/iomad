    ...
    return {
        ...
        init: function(companyid, pathid) {
            ...
            function apply_filter(courses) {
                ...
                templates.render('block_iomad_learningpath/prospectivelist', context)
                    .done(function(html) {
            ...
            function course_list() {
                ...
                ajax.call([{
                    methodname: 'block_iomad_learningpath_getprospectivecourses',
            ...
            function apply_pathcourses(pcl, courses) {
                ...
                templates.render('block_iomad_learningpath/pathcourselist', context)
                    .done(function(html) {
                        $(pcl).append(html);
                    })
                    .fail(notification.exception);
            ...
            function pathcourse_list() {
                ...
                $(".pathcourselist").each(function() {
                    ...
                    var groupid = $(pcl).data('groupid');
                    ajax.call([{
                        methodname: 'block_iomad_learningpath_getcourses',
            ...
            $('#prospectivelist').on('click', '.path-add', function() {
                ...
                ajax.call([{
                    methodname: 'block_iomad_learningpath_addcourses',
            ...
            $('.pathcourselist').on('click', '.path-delete', function() {
                ...
                ajax.call([{
                    methodname: 'block_iomad_learningpath_removecourses',
                    args: {pathid: pathid, courseids: [courseid]},
                    done: function() {
                        pathcourse_list();
                        course_list();
            ...
            $(".pathcourselist").sortable({
                ...
                update: function() {
                    ...
                    // Reorder
                    ajax.call([{
                        methodname: 'block_iomad_learningpath_ordercourses',
