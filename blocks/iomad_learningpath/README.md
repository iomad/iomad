...
The IOMAD Learning path block displays learning paths to users to allow them to access courses in a proscriptive way.
...
The plugin can be also installed by adding the contents of this directory to
    ...
    {your/moodle/dirroot}/blocks/iomad_learningpath
