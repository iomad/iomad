...
$string['iomad_html:addinstance'] = 'Add a new Company text block';
$string['iomad_html:myaddinstance'] = 'Add a new Company text block to Dashboard';
$string['leaveblanktohide'] = 'leave blank to hide the title';
$string['newiomad_htmlblock'] = '(new Company text block)';
$string['pluginname'] = 'IOMAD text';
$string['privacy:metadata:block'] = 'The IOMAD text block only shows data stored in other locations.';
