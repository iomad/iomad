...
class provider implements
        // The block_iomad_html block stores user provided data.
        \core_privacy\local\metadata\provider,

        // This plugin is capable of determining which users have data within it.
        \core_privacy\local\request\core_userlist_provider,

        // The block_iomad_html block provides data directly to core.
        \core_privacy\local\request\plugin\provider {

    /**
     * Returns information about how block_iomad_html stores its data.
     *
    ...
    public static function export_user_data(approved_contextlist $contextlist) {
        ...
        foreach ($instances as $instance) {
            ...
            $block = block_instance('iomad_html', $instance);
            ...
            $html = writer::with_context($context)
                ->rewrite_pluginfile_urls([], 'block_iomad_html', 'content', null, $block->config->text);
    ...
    public static function delete_data_for_all_users_in_context(\context $context) {
        ...
        // The only way to delete data for the iomad_html block is to delete the block instance itself.
    ...
    protected static function get_instance_from_context(\context_block $context) {
        ...
        return $DB->get_record('block_instances', ['id' => $context->instanceid, 'blockname' => 'iomad_html']);
    }
}
