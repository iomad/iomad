...
$string['leanringpath_infocontent'] = 'You have completed <b>{$a->completed}</b> out of <b> {$a->total} </b> courses. The next course in this journey is: <b> {$a->nextcourse}</b>.';
...
$string['resumelearningpath'] = "Resume journey";
...
// START: added by Thomas 28.12.2024: uses IOMAD tracking table to get historical data (all time)
$string['field:iomadcompletedcoursesalltime'] = 'Total completed courses';
$string['label:iomadcompletedcoursesalltime'] = 'Total completed courses';
$string['field:iomadenrolledcoursesalltime'] = 'Total enrolled courses';
$string['label:iomadenrolledcoursesalltime'] = 'Total enrolled courses';
$string['field:iomadcourseswithreminder'] = 'Courses in progress (reminded)';
$string['label:iomadcourseswithreminder'] = 'Courses in progress (reminded)';
$string['field:iomadcourseswithoutreminder'] = 'Courses in progress';
$string['label:iomadcourseswithoutreminder'] = 'Courses in progress';
$string['iomadenrolldate'] = 'Enrolled on';
$string['iomadcompleteddate'] = 'Completed on';
$string['iomadstatus'] = 'Status';
$string['iomadcompleted'] = 'Completed';
$string['iomadreminded'] = 'Reminded';
$string['iomadinprogress'] = 'In progress';
$string['status:infuture'] = 'In future';
//END
//START Thomas 4.1.2025: Strings for microlearning thread learning path
$string['unavailable'] = 'Not yet available';
$string['iomadleanringpath_infocontent'] = 'You have completed <b>{$a->completed}</b> out of <b> {$a->total} </b> courses. The next course in this journey is: <b> {$a->nextcourse}</b>, available from {$a->nextcoursestartdate}.';
//END