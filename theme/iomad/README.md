...
The IOMAD theme IOMAD is a child of the core Moodle Boost theme with functionality added to allow per tenant CSS customisation.
...
The plugin can be also installed by adding the contents of this directory to
    ...
    {your/moodle/dirroot}/theme/iomad
