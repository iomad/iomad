...
The IOMAD theme IOMAD boost is a child of the core Moodle Boost theme with additional functionality added to allow for per tenant CSS customisation.
...
The plugin can be also installed by adding the contents of this directory to
    ...
    {your/moodle/dirroot}/theme/iomadboost
