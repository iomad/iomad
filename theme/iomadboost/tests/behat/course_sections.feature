@theme_iomadboost
Feature: Course sections selector is not available on iomadboost theme
  ...
  Scenario Outline: Course sections selector is not available on iomadboost theme regardless of the course format
