 ...
 *
 * @module     theme_iomadmoon/drawers
...
export default class Drawers {
     ...
     *
     * @static
     * @property {String} drawerShow See {@link event:theme_iomadmoon/drawers:show}
     * @property {String} drawerShown See {@link event:theme_iomadmoon/drawers:shown}
     * @property {String} drawerHide See {@link event:theme_iomadmoon/drawers:hide}
     * @property {String} drawerHidden See {@link event:theme_iomadmoon/drawers:hidden}
     */
    static eventTypes = {
        /**
         * An event triggered before a drawer is shown.
         *
         * @event theme_iomadmoon/drawers:show
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that will be opened.
         */
        drawerShow: 'theme_iomadmoon/drawers:show',

        /**
         * An event triggered after a drawer is shown.
         *
         * @event theme_iomadmoon/drawers:shown
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that was be opened.
         */
        drawerShown: 'theme_iomadmoon/drawers:shown',

        /**
         * An event triggered before a drawer is hidden.
         *
         * @event theme_iomadmoon/drawers:hide
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that will be hidden.
         */
        drawerHide: 'theme_iomadmoon/drawers:hide',

        /**
         * An event triggered after a drawer is hidden.
         *
         * @event theme_iomadmoon/drawers:hidden
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that was be hidden.
         */
        drawerHidden: 'theme_iomadmoon/drawers:hidden',
    };
     ...
     * @returns {module:theme_iomadmoon/drawers}
     */
    ...
    openDrawer({focusOnCloseButton = true} = {}) {
        ...
        const pendingPromise = new Pending('theme_iomadmoon/drawers:open');
    ...
    closeDrawer({focusOnOpenButton = true, updatePreferences = true} = {}) {
        ...
        const pendingPromise = new Pending('theme_iomadmoon/drawers:close');
     ...
     *
     * @param {module:theme_iomadmoon/drawers} comparisonInstance
     */
