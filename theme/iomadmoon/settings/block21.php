...
$page = new admin_settingpage('theme_iomadmoon_block21', get_string('settingsblock21', 'theme_iomadmoon'));

$name = 'theme_iomadmoon/displayblock21';
$title = get_string('turnon', 'theme_iomadmoon');
$description = get_string('displayblock21_desc', 'theme_iomadmoon');
$default = 0;
$setting = new admin_setting_configcheckbox($name, $title .
    '<span class="badge badge-sq badge-dark ml-2">Block #21</span>', $description, $default);
$page->add($setting);

$name = 'theme_iomadmoon/displayhrblock21';
...
$name = 'theme_iomadmoon/block21class';
...
$name = 'theme_iomadmoon/block21introtitle';
...
$name = 'theme_iomadmoon/block21introcontent';
...
$name = 'theme_iomadmoon/block21htmlcontent';
...
$name = 'theme_iomadmoon/block21footercontent';
