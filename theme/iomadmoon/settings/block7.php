...
$page = new admin_settingpage('theme_iomadmoon_block7', get_string('settingsblock7', 'theme_iomadmoon'));

$name = 'theme_iomadmoon/displayblock7';
$title = get_string('turnon', 'theme_iomadmoon');
$description = get_string('displayblock7_desc', 'theme_iomadmoon');
$default = 0;
$setting = new admin_setting_configcheckbox($name, $title .
'<span class="badge badge-sq badge-dark ml-2">Block #7</span>', $description, $default);
$page->add($setting);

$name = 'theme_iomadmoon/displayhrblock7';
...
$name = 'theme_iomadmoon/block7class';
...
$name = 'theme_iomadmoon/block7introtitle';
...
$name = 'theme_iomadmoon/block7introcontent';
...
$name = 'theme_iomadmoon/block7htmlcontent';
...
$name = 'theme_iomadmoon/block7footercontent';
