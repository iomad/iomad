...
$THEME->name = 'iomadmoon';
$THEME->sheets = [];
$THEME->editor_sheets = [];
$THEME->editor_scss = ['editor'];
$THEME->usefallback = true;
$THEME->scss = function ($theme) {
    return theme_iomadmoon_get_main_scss_content($theme);
};
...
$THEME->extrascsscallback = 'theme_iomadmoon_get_extra_scss';
$THEME->prescsscallback = 'theme_iomadmoon_get_pre_scss';
$THEME->precompiledcsscallback = 'theme_iomadmoon_get_precompiled_css';
$THEME->yuicssmodules = [];
...
$navnodes = 'siteadminnode,' . get_config('theme_iomadmoon', 'hidenodesprimarynavigation');
$THEME->removedprimarynavitems = explode(',', $navnodes);

$THEME->settings->hidecourseindexnav = 0;
