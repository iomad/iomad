...
// Hidden sidebar.
switch (theme_iomadmoon_get_setting('turnoffsidebarcourse')) {
    case '1':
        $hiddensidebar = true;
        $navdraweropen = false;
...
if (isloggedin()) {
    ...
    switch (theme_iomadmoon_get_setting('darkmodetheme')) {
        case '1':
...
// Moodle 4.x.
$hidecourseindexnav = (theme_iomadmoon_get_setting('hidecourseindexnav') == true) ? true : false;

switch (theme_iomadmoon_get_setting('hidecourseindexnav')) {
    case false:
...
$hidemainlogo = (theme_iomadmoon_get_setting('hidemainlogo') == '1') ? true : false;
...
echo $OUTPUT->render_from_template('theme_iomadmoon/tmpl-columns2', $templatecontext);
