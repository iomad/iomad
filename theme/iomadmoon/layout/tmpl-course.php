...
// Hidden sidebar.
if (theme_iomadmoon_get_setting('turnoffsidebarcourse') == '1') {
    $hiddensidebar = true;
    $navdraweropen = false;
...
$couseimagesettings = theme_iomadmoon_get_setting('setcourseimage');
...
echo $OUTPUT->render_from_template('theme_iomadmoon/tmpl-course', $templatecontext);
