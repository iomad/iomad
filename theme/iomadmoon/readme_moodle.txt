...
* remove folder theme/iomadmoon/scss/bootstrap
* copy the scss files from ~/bootstrap/scss to theme/iomadmoon/scss/bootstrap
...
* comment out this line in theme/iomadmoon/scss/_print.scss
    @page {
...
* copy the js files from ~/bootstrap/js/src to theme/iomadmoon/amd/src/bootstrap (including the subfolder)
