...
class autoprefixer {
    ...
    public function __construct(Document $tree) {
        debugging('theme_iomadmoon\autoprefixer() is deprecated. Required prefixes for Bootstrap ' .
            'are now in theme/iomadmoon/scss/moodle/prefixes.scss', DEBUG_DEVELOPER);
        $this->tree = $tree;
