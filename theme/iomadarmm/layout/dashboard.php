...
$sidepre = $OUTPUT->blocks('side-pre');
$hassidepre = strpos($sidepre, 'data-block=') !== false;

$sidepost = $OUTPUT->blocks('side-post');
$hassidepost = strpos($sidepost, 'data-block=') !== false;
...
echo $OUTPUT->render_from_template('theme_iomadarmm/dashboard', $templatecontext);
