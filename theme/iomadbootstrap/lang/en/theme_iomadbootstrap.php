...
/**
 * Strings for component 'theme_iomadbootstrap', language 'en', branch 'MOODLE_23_STABLE'
 *
...
$string['customjsdesc'] = 'Whatever JavaScript rules you add to this textarea will be reflected in every page, making for easier customization of this theme.';
...
$string['pluginname'] = 'Iomad Bootstrap 3';
...
<img class=img-polaroid src="iomadbootstrap/pix/screenshot.jpg" />
<h3>Theme Credits</h3>
<p>
<h3>Moodle Iomad Bootstrap 3 theme</h3>
<p>
This theme is based on the Bootstrap CSS framework, version 3.0
</p>
<p>
<a href="http://getiomadbootstrap.com">http://getbootstrap.com</a>
</p>
<p>
This is a GPL theme that is available on GitHub:
</p>
<p>
<a href=https://github.com/bmbrands/theme_iomadbootstrap">https://github.com/bmbrands/theme_bootstrap</a>
</p>
<p>
...
<p>You can report bugs on the <a href="https://github.com/bmbrands/theme_iomadbootstrap/issues">github page</a> for this theme or
on the Moodle tracker</p>

<h3>More information</h3>
<ul>
<li><a href="https://github.com/bmbrands/theme_iomadbootstrap/wiki">Wiki page for this theme</a>
<li><a href="http://docs.moodle.org/23/en/iomadbootstrap-Theme">Bootstrap on Moodle docs</a></li>
